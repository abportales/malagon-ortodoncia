    ...
    return (
        <>
            <div id="darkBackground">
                <div className="container w-75" id="containerFrecuency">
                            ...
                            <div className='col-12 d-flex px-3 pt-2 rounded' >
                                <div className='align-self-center' >
                                    ...
                                    <div className="row d-flex">
                                        <p className='text-white px-4 col-lg-5 offset-lg-1 ' id='responsiveText' align="justify">
                                        ...
                                        <p className='text-white px-4 col-lg-5' id='responsiveText' align="justify">
                        ...
                        <div className='row' id='gradient1C'>
                            ...
                            <div className='col-12 d-flex px-3 pt-2' id='gradient1C'>
                                <div className='align-self-center' >
                                    ...
                                    <ul id='responsiveText' className='row'>
                                        <li className='text-white px-4 col-lg-4 offset-lg-2' align="justify">El tipo de material va a determinar principalmente su estética. Los brackets metálicos son los más habituales, fabricados en acero y titanio, muy resistentes, generalmente más económicos, pero mucho más visibles. Los brackets estéticos se fabrican en varios materiales: resina o policarbonato, cerámica y zafiro. Cada uno de ellos con sus ventajas e inconvenientes.</li>
                                        <li className='text-white px-4 col-lg-3 offset-lg-1' align="justify">A parte del material, podemos diferenciar los tipos de brackets según cómo se unen al arco. En ese sentido podemos hablar de: Brackets convencionales y Brackets autoligables.</li>
                                    </ul>
